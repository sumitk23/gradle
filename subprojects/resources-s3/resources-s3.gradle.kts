...
dependencies {
    ...
    implementation(library("awsS3_core"), library("awsS3_s3"), library("awsS3_kms"))
...
val javaVersion = rootProject.availableJavaInstallations.javaInstallationForTest.javaVersion
